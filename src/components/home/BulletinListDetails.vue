  ...
  <div class="BulletinList">
    <div class="two">
      <div class="BulletinListNavigation">
        ...
        <router-link to="/BulletinList">公告列表</router-link> ->
        <span class="colorB">公告详情</span>
      </div>
      ...
      <div class="contain" v-html="list.content">
        ...
        <div>
          <BulletinListDetailsleft></BulletinListDetailsleft>
        </div>
        <!-- <div class="rightBox">
      ...
      <div class="moreListBox" v-for="(item,index) in moreList" :key="index" @click="toDetail(item.id)">
        ...
        <div>
          <BulletinListDetailsright></BulletinListDetailsright>
        </div>
      </div>
    </div>
  </div>
...
import BulletinListDetailsright from "@/components/home/BulletinListDetailsright";
import BulletinListDetailsleft from "@/components/home/BulletinListDetailsleft";

export default {
  name: "BulletinListDetails",
  components: { BulletinListDetailsright, BulletinListDetailsleft },
  data() {
    return {
      list: "",
      moreList: []
