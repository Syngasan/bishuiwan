  ...
  <div class="task">
      ...
      <el-form :inline="true">
        ...
        <el-row style="margin-top:20px">
          <el-col :span="8">
            ...
            <el-input placeholder="请输入事件主题" size="small" class="EventTheme" style="width:200px" v-model="DraftTaskDetail.title"></el-input>
            <!-- </el-form-item> -->
          ...
          <el-col :span="8">
            ...
            <el-select v-model="DraftTaskDetail.eventTypeId" placeholder="请选择" size='small' class="EventTheme" style="width:200px">
        ...
        <el-row class="mt">
          <el-col :span="8" class="mt">
            ...
            <el-select v-model="DraftTaskDetail.secondExamineUserId" class="EventTheme" placeholder="请输入 \ 选择" size='small' style="width:200px" filterable>
              <el-option v-for="item in options" :key="item.value" :label="item.nick" :value="item.userId">
              </el-option>
            </el-select>
            <!-- </el-form-item> -->
          </el-col>
          <el-col :span="8" class="mt">
            ...
            <el-input placeholder="" class="EventTheme" size="small" style="width:80px" v-model="DraftTaskDetail.reward" oninput="value=value.replace(/[^0-9-]+/,'')"></el-input>&nbsp;分
            <!-- </el-form-item> -->
          </el-col>
          <el-col :span="8" class="mt">
            <!-- <el-form-item label="未完成扣分"> -->
            <span class="eventtypetheme">未完成扣分</span>
            <el-input size="small" style="width:80px" class="EventTheme" v-model="DraftTaskDetail.deduction" oninput="value=value.replace(/[^0-9-]+/,'')"></el-input> &nbsp;分
            <!-- </el-form-item> -->
          </el-col>
        </el-row>
        <el-row class="mt">
          <el-col :span="24" style="display:flex" class="mt">
            ...
            <el-input placeholder="请输入备注内容" size="small" class="EventTheme" style="width:200px;margin-left:36px" v-model="DraftTaskDetail.remark"></el-input>
            <!-- </el-form-item> -->
          </el-col>
        </el-row>
        <el-row class="mt">
          <el-col :span="24" style="display:flex" class="mt">
            ...
            <el-input type="textarea" :rows="6" placeholder="请输入事件内容" v-model="DraftTaskDetail.content">
            </el-input>
            <!-- </el-form-item> -->
          </el-col>
        </el-row>
        <el-row class="mt">
          <el-col :span="8" class="mt">
            ...
            <el-select v-model="DraftTaskDetail.ranges" class="EventTheme" placeholder="请选择推送范围" size='small' style="width:200px" @change="tuisong(DraftTaskDetail.ranges)">
          ...
          <el-col :span="8" class="mt">
            ...
            <el-input placeholder="请输入数量上限" :disabled="numberInput" class="EventTheme" size="small" style="width:200px" oninput="value=value.replace(/[^\d]/g,'')" v-model="DraftTaskDetail.number"></el-input>
            <!-- </el-form-item> -->
          </el-col>
        </el-row>
        <!-- 设置推送范围 -->
        ...
        <el-row>
          <el-col :span="8" class="mt">
            ...
            <el-date-picker type="datetime" class="EventTheme" placeholder="请选择完成期限" size="small" style="width:200px" value-format="yyyy-MM-dd HH:mm:ss" v-model="DraftTaskDetail.endTime" @change="getEndTime"></el-date-picker>
            <!-- </el-form-item> -->
          </el-col>
          <el-col :span="8" class="mt">
            <!-- <el-form-item label="完成期限"> -->
            <span class="eventtypetheme">完成期限</span>
            <el-date-picker type="datetime" class="EventTheme" placeholder="请选择完成期限" size="small" style="width:200px" value-format="yyyy-MM-dd HH:mm:ss" v-model="DraftTaskDetail.happenTime" @change="getHappenTime"></el-date-picker>
            <!-- </el-form-item> -->
          </el-col>
    ...
    <el-dialog title="可见范围" :visible.sync="dialogVisible" width="40%">
      ...
      <div class="treeBox">
        ...
        <el-button @click="bufenCommit()" type="primary" size="small" style="text-align:right;    position: absolute;
    right: 0;
    bottom: 0;">确定</el-button>
      </div>
    </el-dialog>
          ...
          <el-scrollbar style="height:250px;overflow-x: hidden;">
            ...
            <el-tree :data="data4" show-checkbox node-key="id" :props="prop9" :expand-on-click-node="false" @check-change="check_right_change" ref="tree" :filter-node-method="filterNodes">
              <span class="custom-tree-node" slot-scope="{ node, data }">
                ...
                <span>
                  <el-button class="fuckBtn" v-show="data.hasOwnProperty('account')" type="text" size="mini" @click="() => append(data)">
                    设为常选
...
export default {
  ...
  methods: {
    ...
    add() {
      ...
      // console.log(this.doUserId, "结果数组", arr.length);
      let arr = [];
      let newArr = [];
      ...
      this.DraftTaskDetail.number = arr.length;
      this.dialogVisible1 = false;
      this.numberInput = true;
      this.DraftTaskDetail.ranges = "";
      this.DraftTaskDetail.ranges = "定向推送";
    ...
    bufenCommit() {
      ...
      this.number = "";
      this.DraftTaskDetail.ranges = "";
      this.DraftTaskDetail.ranges = "部分可见";
    },
    getHappenTime(val) {
    ...
    commit() {
      ...
      updateDraftTask(this.$qs.stringify(params)).then(res => {
        ...
        // if(res.code === 1) {
        //     this.$confirm('您可以继续发布新的任务，也可以查看刚才发布的任务！', '发布成功',{
    ...
    init() {
      ...
      getDraftTaskDetail(this.$qs.stringify(params)).then(res => {
        ...
        if (res.code === 1) {
          ...
          this.newRanges = this.DraftTaskDetail.ranges;
          console.log(this.DraftTaskDetail, "返回数据实时");
          if (res.data.ranges == 0) {
            this.numberInput = false;
          } else {
            this.numberInput = true;
          }
    ...
    // 推送
    tuisong(val) {
      console.log(this.optionPeople, "推送", val);
      // switch (val) {
      //   case val===1:
      ...
      if (val === 1) {
        ...
        this.newRanges = val;
        this.ranges1 = val;
        this.DraftTaskDetail.ranges = val;
