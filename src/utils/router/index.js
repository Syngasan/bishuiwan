...
const router = new Router({
  mode: 'history',
  // base: 'http://47.107.71.47/bishuiwan/index.html',
    ...
    },
    {
      ...
      children: [{
        ...
        // 公告详情
        {
          ...
          children: [{
              path: 'BulletinListDetailsright',
              name: 'BulletinListDetailsright',
              component: resolve => require(['@/components/home/BulletinListDetailsright'], resolve)
            },
            {
              path: 'BulletinListDetailsleft',
              name: 'BulletinListDetailsleft',
              component: resolve => require(['@/components/home/BulletinListDetailsleft'], resolve)
            }
          ]
        },
        // 积分管理
        ...
        // 积分报表
        {
          ...
          children: [{
            ...
            {
              path: 'integralReport1',
              name: 'integralReport1',
              component: resolve => require(['@/components/ReportForm/integralReport1'], resolve),
              children: [{
                  path: 'integralReport',
                  name: 'integralReport',
          ...
          children: [{
            ...
            // 月积分
            {
              ...
              children: [{
                  path: 'MyPoints1',
                  name: 'MyPoints1',
                  component: resolve => require(['@/components/personal/MyPoints1'], resolve)
                },
                // 累计积分
                {
