<template>
  <div class="task">
    ...
    <div class="title">
      <div class="left_title1">{{taskDetail.title}}</div>
      <div class="right_title">
        <div>
          {{taskDetail.reward}}/{{ taskDetail.deduction }}
        </div>
    ...
    <div class=" mt" v-if="taskDetail.ranges == 1" style="margin-bottom:50px">
      ...
      <!-- <div class="task_content_content " style="display: flex;justify-content: flex-start;">
        <ul v-for="(item , index) in taskDetail.departmentList" :key="index">
          <li>
    ...
    <div class=" mt" v-if="taskDetail.ranges == 2" style="margin-bottom:50px">
      <!-- <img src="../../images/nav_sun.png" class="left_div_img">
              <div>
                <div>王小明</div>
              <div>部门</div>
      ...
      <div class="task_content_content " style="display: flex;justify-content: flex-start;">
        <ul v-for="(item , index) in taskDetail.userList" :key="index">
          <li v-if="index<5">
            <el-button type="primary" size="small">{{ item.realName }}</el-button>
          </li>
        </ul>
      </div>
    </div>

    <div class="task_content " style="margin-top:60px">
      <div class="task_content_title">
        任务内容：
      </div>
    ...
    <div class="getTask mt">
      ...
      <div class="getTask_content">
        <ul style="display: flex;justify-content: center;padding-inline-start: 0;">
          <li v-for="(item,index) in taskDetail.userList" :key="index" v-if="index<12" class="img50 mr5">
            <div>
    ...
    <div class="getTask mt" style="margin-top:90px">
      ...
      <div class="getTask_content">
        <ul style="display: flex;justify-content: center;padding-inline-start: 0;">
          <li v-for="(item,index) in taskDetail.finshUserList" :key="index" v-if="index<12" class="img50 mr5">
            <div>
              <img :src="url+item.head" alt="" class="getimg">
            </div>
          </li>
...
<script>
import { getPublishTaskDetail, getTask } from "@/utils/axios/axios";
export default {
  data() {
    return {
      dialogVisible: false,
