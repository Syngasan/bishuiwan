<template>
  <div class="task">
    ...
    <div class="bigBox">
      ...
      <div class="block" style="text-align:center" v-show="length!=0">
        <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="pageNumber" :page-sizes="[1, 2, 3, 4]" :page-size="pageSize" layout="total, sizes, prev, pager, next, jumper" :total="length">
        </el-pagination>
      </div>
    </div>
    <!-- <div v-show="length===0" style="text-align:center">暂时没有任务</div> -->
  </div>
</template>
<script>
import { getCurrentTaskList } from "@/utils/axios/axios";
export default {
  data() {
    return {
      index: "",
